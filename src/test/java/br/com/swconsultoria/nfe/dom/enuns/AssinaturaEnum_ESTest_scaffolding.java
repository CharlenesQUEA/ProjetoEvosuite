...
public class AssinaturaEnum_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.swconsultoria.nfe.dom.enuns.AssinaturaEnum"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AssinaturaEnum_ESTest_scaffolding.class.getClassLoader() ,
      "br.com.swconsultoria.nfe.dom.enuns.AssinaturaEnum"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AssinaturaEnum_ESTest_scaffolding.class.getClassLoader()); 
