...
public class DocumentoEnum_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.swconsultoria.nfe.dom.enuns.DocumentoEnum"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DocumentoEnum_ESTest_scaffolding.class.getClassLoader() ,
      "br.com.swconsultoria.nfe.dom.enuns.DocumentoEnum"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DocumentoEnum_ESTest_scaffolding.class.getClassLoader()); 
