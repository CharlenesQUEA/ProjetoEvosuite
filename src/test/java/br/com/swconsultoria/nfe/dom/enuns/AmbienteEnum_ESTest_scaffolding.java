...
public class AmbienteEnum_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.swconsultoria.nfe.dom.enuns.AmbienteEnum"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AmbienteEnum_ESTest_scaffolding.class.getClassLoader() ,
      "br.com.swconsultoria.nfe.dom.enuns.AmbienteEnum"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AmbienteEnum_ESTest_scaffolding.class.getClassLoader()); 
