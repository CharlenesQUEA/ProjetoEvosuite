...
public class KeyInfoType_ESTest extends KeyInfoType_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      keyInfoType0.setId("br.com.swconsultoria.nfe.schema.eventoCancNFe.X509DataType");
      assertEquals("br.com.swconsultoria.nfe.schema.eventoCancNFe.X509DataType", keyInfoType0.getId());
  }
  ...
  public void test2()  throws Throwable  {
      KeyInfoType keyInfoType0 = new KeyInfoType();
      keyInfoType0.id = "}>|o^+eab'VnCm93";
      String string0 = keyInfoType0.getId();
      assertEquals("}>|o^+eab'VnCm93", string0);
  }
