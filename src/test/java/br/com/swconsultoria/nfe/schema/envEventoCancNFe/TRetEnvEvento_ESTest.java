...
public class TRetEnvEvento_ESTest extends TRetEnvEvento_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      tRetEnvEvento0.setXMotivo("r][%be");
  ...
  public void test01()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.xMotivo = "aVuK`+A?WQML)hd";
      String string0 = tRetEnvEvento0.getXMotivo();
      assertEquals("aVuK`+A?WQML)hd", string0);
  }
  ...
  public void test03()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.setVersao("r][%be");
      String string0 = tRetEnvEvento0.getVersao();
      assertEquals("r][%be", string0);
  }
  ...
  public void test05()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.verAplic = "LTX_0[2:b";
      String string0 = tRetEnvEvento0.getVerAplic();
      assertEquals("LTX_0[2:b", string0);
  }
  ...
  public void test10()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.idLote = "_4_2hJO9FJagma";
      String string0 = tRetEnvEvento0.getIdLote();
      assertEquals("_4_2hJO9FJagma", string0);
  }
  ...
  public void test12()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.setCStat("{RLLHi7z\"~-H1EGPG");
      String string0 = tRetEnvEvento0.getCStat();
      assertEquals("{RLLHi7z\"~-H1EGPG", string0);
  }
  ...
  public void test14()  throws Throwable  {
      TRetEnvEvento tRetEnvEvento0 = new TRetEnvEvento();
      tRetEnvEvento0.setCOrgao("br.com.swconsultoria.nfe.schema.envEventoCancNFe.SignatureValueType");
      String string0 = tRetEnvEvento0.getCOrgao();
      assertEquals("br.com.swconsultoria.nfe.schema.envEventoCancNFe.SignatureValueType", string0);
  }
