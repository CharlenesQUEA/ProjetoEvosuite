...
public class ConfiguracoesNfe {
 ...
 //Minhas modificações para inicializar
    public ConfiguracoesNfe iniciaConfiguracoes() throws NfeException, FileNotFoundException {
        try {
            // Configura o caminho do certificado
            String caminhoCertificado = "c:/certificado/certificado.pfx";
            // Senha do certificado
            String senha = "123456";

            // Carrega o certificado a partir do arquivo .pfx
            Certificado certificado = CertificadoService.certificadoPfx(caminhoCertificado, senha);

            // Configura o caminho da pasta onde se encontram os esquemas Xsd
            //String pastaSchemas = "C:\\SRA\\Nfe\\Schemas";
            String pastaSchemas = "C:\\Users\\charl\\Downloads\\Deletar depois\\Plugins evosuite\\Java_NFe-master\\Schemas";

            // Inicializa as configurações com o estado de Goiás (GO) e ambiente de homologação
            ConfiguracoesNfe configuracoesNfe = ConfiguracoesNfe.criarConfiguracoes(EstadosEnum.GO, AmbienteEnum.HOMOLOGACAO, certificado, pastaSchemas);
            ...
            String usuario = "";
            String senhaProxy = "";
            Proxy proxy = new Proxy(ip, porta, usuario, senhaProxy);
            configuracoesNfe.setProxy(proxy);

            return configuracoesNfe;
        } catch (CertificadoException e) {
            throw new NfeException("Erro ao configurar o certificado", e);
        }
    }
