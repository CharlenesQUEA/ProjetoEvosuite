...
public class EstadosEnum_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "br.com.swconsultoria.nfe.dom.enuns.EstadosEnum"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EstadosEnum_ESTest_scaffolding.class.getClassLoader() ,
      "br.com.swconsultoria.nfe.dom.enuns.EstadosEnum"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EstadosEnum_ESTest_scaffolding.class.getClassLoader()); 
