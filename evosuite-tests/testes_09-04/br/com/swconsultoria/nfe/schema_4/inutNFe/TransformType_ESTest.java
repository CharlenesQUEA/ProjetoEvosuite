...
public class TransformType_ESTest extends TransformType_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      linkedList0.add(">1,?|?BCga");
      List<String> list0 = transformType0.getXPath();
      assertTrue(list0.contains(">1,?|?BCga"));
  }

  @Test(timeout = 4000)
  public void test1()  throws Throwable  {
      TransformType transformType0 = new TransformType();
      transformType0.setAlgorithm("br.com.swconsultoria.nfe.schema_4.inutNFe.TransformType");
      String string0 = transformType0.getAlgorithm();
      assertEquals("br.com.swconsultoria.nfe.schema_4.inutNFe.TransformType", string0);
  }
